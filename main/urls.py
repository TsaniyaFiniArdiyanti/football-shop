...
from main.views import edit_product_ajax, delete_product_ajax, proxy_image, create_product_flutter
from main.views import get_my_products_json
...
urlpatterns = [
    ...
    path('get-my-products/', get_my_products_json, name='get_my_products_json')
]